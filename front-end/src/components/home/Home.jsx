            ...
            <div className='container mt-3'>
                <section className='jumbotron text-center shadow'>
                    <div className='container justify-content-between'>
                        <h1 className='jumbotron-heading font-weight-bold'>Welcome to Rent-Ride !</h1>
                        <h3 className="mb-4">Fast and easy vehicle renting</h3>
                        <div>
                            <Link to='/cars/all' className='btn btn-primary mr-3 shadow-sm'>vehicle fleet</Link>
                            {
